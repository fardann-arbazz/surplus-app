{{-- resources/views/partials/user/location-picker.blade.php --}}
...
<button id="locationTrigger" onclick="LocationPicker.open()"
    ...
    {{-- Teks lokasi --}}
    <span id="locText" class="max-w-[120px] truncate font-medium text-base-content/80">Lokasi tersimpan</span>
    {{-- Status dot --}}
...
{{-- Full-Screen Modal --}}
<div id="locationModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-red-500"
