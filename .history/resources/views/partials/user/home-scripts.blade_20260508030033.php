...
<script>
    ...
    const HomeApp = (function() {
        ...
        function formatMenuData(item) {
            ...
            var discountPrice = parseFloat(product.discount_price || 0);
            ...
            for (var i = 0; i < menus.length; i++) {
                ...
                <div class="card bg-base-100 border border-base-200 shadow-sm hover:shadow-md transition-all overflow-hidden group cursor-pointer"
                    ...
                    <figure class="relative h-36 lg:h-44">
                        ...
                        <button onclick="event.stopPropagation(); addToCartGlobal(${menu.id}, {id: ${menu.id}, name: '${name.replace(/'/g, "\\'")}', price: ${menu.price}, image: '${menu.image}', storeName: '${restaurant.replace(/'/g, "\\'")}'})"
